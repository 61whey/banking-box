...
📁 Исходные PlantUML файлы и инструкции: [`docs/diagrams/`](./docs/diagrams/README.md)
...
**Важно:** При запросе consent необходимо передавать заголовок `x-requesting-bank: team200`!
